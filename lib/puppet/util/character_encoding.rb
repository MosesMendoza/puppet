...
module Puppet::Util::CharacterEncoding
  class << self
    ...
    # Given a string, attempt to convert the string to UTF-8. Conversion uses
    ...
    # Warning! This is a destructive method - the string supplied is modified!
    # Given a string, test if that string's bytes represent valid UTF-8, and if
    # so set the external encoding of the string to UTF-8. Does not modify the
    # byte representation of the string. If the string does not represent valid
    # UTF-8, do not set the external encoding.
    #
