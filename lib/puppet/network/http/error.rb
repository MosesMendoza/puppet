...
module Puppet::Network::HTTP::Error
  ...
  class HTTPServerError < HTTPError
    ...
    def initialize(original_error, issue_kind = Issues::RUNTIME_ERROR)
      ...
      @backtrace = ["Warning: The 'stacktrace' property is deprecated and will be removed in a future version of Puppet. For security reasons, stacktraces are not returned with Puppet HTTP Server Error responses."]
    end
